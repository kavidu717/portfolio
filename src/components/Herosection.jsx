    ...
    <section className="relative w-full min-h-screen bg-slate-950 flex items-center justify-center py-20 px-6 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="order-2 lg:order-1 text-center lg:text-left space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-8">
            ...
            <div className="flex gap-6 items-center">
              <a 
                ...
                className="text-white text-3xl hover:text-cyan-400 transition-all duration-300 transform hover:-translate-y-1"
              >
                <FaGithub />
              </a>
              <a 
          ...
          <div className="pt-8 flex justify-center lg:justify-start gap-12 border-t border-slate-900">
        ...
        <div className="order-1 lg:order-2 flex justify-center items-center">
          <div className="relative group">
            ...
            <div className="relative bg-slate-900 p-2 rounded-2xl">
              <img 
                src="profile pic.jpg" 
                alt="Kavidu Dushamantha" 
                className="w-72 h-72 md:w-[450px] md:h-[450px] object-cover rounded-xl grayscale hover:grayscale-0 transition-all duration-700 shadow-2xl"
              />
            </div>

            
            <div className="absolute -bottom-6 -left-6 bg-slate-900 border border-slate-800 p-5 rounded-xl shadow-2xl hidden md:block">
              <p className="text-cyan-400 font-bold text-2xl leading-none">Kelaniya</p>
              <p className="text-slate-500 text-[10px] uppercase tracking-[0.2em] mt-1">University Student</p>
            </div>
          </div>
        </div>
